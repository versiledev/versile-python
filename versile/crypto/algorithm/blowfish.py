...
class Blowfish(object):
    ...
    When initialized the object can encipher and decipher blocks of
    data with the :meth:`encipher` and :meth:`decipher` methods.
    ...
    def _encipher_block(self, block):
